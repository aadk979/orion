...
import { validateConfig, OrchestratorConfigSchema, WorkerConfigSchema } from '../lib/utils/configSchemas.js';

describe('configSchemas', () => {
    it('applies orchestrator trustAdvertisedWorkerIp default false', () => {
        const v = validateConfig({ role: 'ORCHESTRATOR', cluster: 'c1' }, OrchestratorConfigSchema);
    ...
    it('rejects invalid role', () => {
        assert.throws(() => validateConfig({ role: 'BOT', cluster: 'c' }, OrchestratorConfigSchema), /Configuration validation failed/);
    });
