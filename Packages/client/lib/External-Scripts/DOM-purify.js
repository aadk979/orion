 ...
 * Original file: /npm/dompurify@3.2.5/dist/purify.es.mjs
 *
...
var re = (function t() {
        ...
        gt = function () {
            ...
            if (!ft || ft !== e) {
                if (
                    ...
                    (be = _(e, 'ALLOWED_TAGS') ? w({}, e.ALLOWED_TAGS, pt) : Re),
                    (we = _(e, 'ALLOWED_ATTR') ? w({}, e.ALLOWED_ATTR, pt) : Oe),
                    (it = _(e, 'ALLOWED_NAMESPACES') ? w({}, e.ALLOWED_NAMESPACES, g) : at),
                    (Je = _(e, 'ADD_URI_SAFE_ATTR') ? w(v(Qe), e.ADD_URI_SAFE_ATTR, pt) : Qe),
                    (Ve = _(e, 'ADD_DATA_URI_TAGS') ? w(v(Ze), e.ADD_DATA_URI_TAGS, pt) : Ze),
                    ($e = _(e, 'FORBID_CONTENTS') ? w({}, e.FORBID_CONTENTS, pt) : Ke),
                    (De = _(e, 'FORBID_TAGS') ? w({}, e.FORBID_TAGS, pt) : {}),
                    ...
                    (je = !1 !== e.KEEP_CONTENT),
                    (Xe = e.IN_PLACE || !1),
                    (Ne = e.ALLOWED_URI_REGEXP || X),
                    (ot = e.NAMESPACE || nt),
                    (lt = e.MATHML_TEXT_INTEGRATION_POINTS || lt),
                    (ct = e.HTML_INTEGRATION_POINTS || ct),
                    (ve = e.CUSTOM_ELEMENT_HANDLING || {}),
                    e.CUSTOM_ELEMENT_HANDLING && ht(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (ve.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                    ...
                    e.ADD_TAGS && (be === Re && (be = v(be)), w(be, e.ADD_TAGS, pt)),
                    e.ADD_ATTR && (we === Oe && (we = v(we)), w(we, e.ADD_ATTR, pt)),
                    e.ADD_URI_SAFE_ATTR && w(Je, e.ADD_URI_SAFE_ATTR, pt),
                    e.FORBID_CONTENTS && ($e === Ke && ($e = v($e)), w($e, e.FORBID_CONTENTS, pt)),
                    je && (be['#text'] = !0),
    ...
    const wt = function (e) {
            ...
            if (
                (Rt(de.uponSanitizeElement, e, { tagName: n, allowedTags: be }),
                e.hasChildNodes() && !bt(e.firstElementChild) && S(/<[/\w!]/g, e.innerHTML) && S(/<[/\w!]/g, e.textContent))
            )
                return (Et(e), !0);
                            ...
                            : e.namespaceURI === et
                              ? t.namespaceURI === nt
                                  ...
                                  : t.namespaceURI === tt
                                    ...
                                    : Boolean(yt[n])
                              : e.namespaceURI === nt
                                ? !(t.namespaceURI === tt && !ct[o]) && !(t.namespaceURI === et && !lt[o]) && !yt[n] && (st[n] || !Tt[n])
        ...
        Dt = function (e) {
            ...
            for (; r--;) {
                ...
                if (
                    ...
                    (m = n.attrValue),
                    !Ye || ('id' !== s && 'name' !== s) || (At(a, e), (m = 'user-content-' + m)),
                ...
                if (Ot(f, s, m)) {
                    ...
                    try {
                        (l ? e.setAttributeNS(l, a, m) : e.setAttribute(a, m), Nt(e) ? Et(e) : p(o.removed));
                    } catch (e) {}
                }
            }
    ...
    return (
        (o.sanitize = function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                i = null,
                l = null;
            if (((rt = !e), rt && (e = '\x3c!--\x3e'), 'string' != typeof e && !bt(e))) {
            ...
            if ((Pe || gt(t), (o.removed = []), 'string' == typeof e && (Xe = !1), Xe)) {
                if (e.nodeName) {
                    ...
                    if (!be[t] || De[t]) throw N('root node is forbidden and cannot be sanitized in-place');
                }
...
//# sourceMappingURL=/sm/ef0976ebd290314501be4dbae8efa4b7e835da40376d4b187064acf47c49e2c4.map
