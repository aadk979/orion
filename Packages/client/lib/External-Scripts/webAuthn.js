...
function r() {
    return n.stubThis(void 0 !== globalThis?.PublicKeyCredential && 'function' == typeof globalThis.PublicKeyCredential);
}
...
async function u(n) {
    ...
    const h = {
        ...
        p = {};
    let R;
    (u && (p.mediation = 'conditional'), (p.publicKey = h), (p.signal = s.createNewAbortSignal()));
    try {
    ...
    let E, m, A, y;
    if (('function' == typeof w.getTransports && (E = w.getTransports()), 'function' == typeof w.getPublicKeyAlgorithm))
        try {
...
function h() {
    ...
    return void 0 === e?.isConditionalMediationAvailable ? p.stubThis(new Promise(e => e(!1))) : p.stubThis(e.isConditionalMediationAvailable());
}
...
async function R(n) {
    !n.optionsJSON &&
        ...
        (n = { optionsJSON: n }));
    const { optionsJSON: c, useBrowserAutofill: u = !1, verifyBrowserAutofillInput: d = !0 } = n;
    if (!r()) throw new Error('WebAuthn is not supported in this browser');
    let p;
