            ...
            return (function (c) {
                ...
                for (; i && ((i = 0), c[0] && (a = 0)), a; )
                    try {
                        if (
                            ((t = 1),
                            r && (o = 2 & c[0] ? r.return : c[0] ? r.throw || ((o = r.return) && o.call(r), 0) : r.next) && !(o = o.call(r, c[1])).done)
                        )
                            return o;
...
function j() {
    var n = window;
    return (
        f(['ApplePayError' in n, 'CSSPrimitiveValue' in n, 'Counter' in n, 0 === navigator.vendor.indexOf('Apple'), 'RGBColor' in n, 'WebKitMediaKeys' in n]) >=
        4
    );
}
function X() {
...
function A() {
    var n = Y(),
        ...
        o = 'connection';
    return n
        ? f([!('SharedWorker' in t), r[o] && 'ontypechange' in r[o], !('sinkId' in new Audio())]) >= 2
        : !!e && f(['onorientationchange' in t, 'orientation' in t, /android/i.test(r.appVersion)]) >= 2;
}
function N() {
    var n = navigator,
        e = window,
                            ...
                            [
                                ...
                                new Promise(function (n, t) {
                                    ...
                                    var c = function () {
                                        ...
                                        o ||
                                            ('complete' ===
                                            (null === (e = null === (n = l.contentWindow) || void 0 === n ? void 0 : n.document) || void 0 === e
                                                ? void 0
                                                : e.readyState)
                                                ? i()
                                                : setTimeout(c, 10));
                                ...
                                ? q
                                    ...
                                    : H()
                                      ? [
                                            4,
                                            ((t = document),
                                            (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))
                                        ]
                                      : [3, 2]
                                : [3, 2];
                        case 1:
...
function rn(n) {
    ...
    return e(this, void 0, void 0, function () {
        ...
        return t(this, function (t) {
            switch (t.label) {
                case 0:
                    for (e = document, i = e.createElement('div'), a = new Array(n.length), c = {}, on(i), s = 0; s < n.length; ++s)
                        ('DIALOG' === (u = _(n[s])).tagName && u.show(), on((l = e.createElement('div'))), l.appendChild(u), i.appendChild(l), (a[s] = u));
                    t.label = 1;
                case 1:
        ...
        return (function (n, e) {
            ...
            return D(function (t, o) {
                ...
                ((c.width = ''.concat(e, 'px')),
                    ...
                    Y() ? (a.style.zoom = ''.concat(1 / o.devicePixelRatio)) : j() && (a.style.zoom = 'reset'));
    ...
    audio: function () {
        return (j() && E() && C()) ||
            (Y() &&
                ...
                ((n = window),
                (e = n.URLPattern),
                f(['union' in Set.prototype, 'Iterator' in n, e && 'hasRegExpGroups' in e.prototype, 'RGB8' in WebGLRenderingContext.prototype]) >= 3))
            ? -4
            : J();
        var n, e;
    },
    ...
    platform: function () {
        ...
        return 'MacIntel' === n && j() && !X()
            ? (function () {
                  ...
                  var n = screen,
                      e = n.width / n.height;
                  return f(['MediaSource' in window, !!Element.prototype.webkitRequestFullscreen, e > 0.65 && e < 1.53]) >= 2;
              })()
                ? 'iPad'
                : 'iPhone'
            : n;
